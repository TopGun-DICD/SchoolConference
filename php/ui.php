...
function ui_print_menubar() {
        ...
        <div class="collapse navbar-collapse" id="navbar-data">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdown-about" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">О конференции</a>
                    <div class="dropdown-menu" aria-labelledby="dropdown-about">
                        <a class="dropdown-item" href="' . __SITE_BASE__ . 'about/about.php">О конференции "Творчество юных"</a>
                        <hr/>
                        ...
                        <hr/>
                        <a class="dropdown-item" href="' . __SITE_BASE__ . 'about/history.php">Прошедшие конференции</a>
                    </div>
                </li>
    ...
    if (!isset($_SESSION['username']))
        ...
        echo '
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="#">Статус:
        ';
        switch($_SESSION['status']) {
            case 0  :   echo 'школьник';        break;
            case 1  :   echo 'студент';         break;
            case 2  :   echo 'член жюри';       break;
            case 3  :   echo 'администратор';   break;
            case 4  :   echo 'студент ссуза';   break;
        }
        echo '
                        </a>
                        <hr/>
        ...
        switch($_SESSION['status']) {
            case 0  :
            case 1  :
            case 4  :   echo 'Мои проекты';     break;
            case 2  :
            case 3  :   echo 'Список проектов'; break;
        }
        echo '
                        </a>
                        <hr/>
